...
if st.button('Save Pair to GitHub'):
    # Replace 'stockA' and 'stockB' with your actual stock symbols
    if save_pair_to_github(stockA, stockB, window_size, entry_zscore):
        st.success('Pair saved')
    else:
        st.error('Failed to save pair to GitHub.')
